...
@onready var overlay_rect: ColorRect
...
func _ready():
	...
	vision_shader = preload("res://shaders/vision_overlay.gdshader")
...
func _process(delta):
	...
	overlay_rect.material.set_shader_parameter("vision_radius", player.vision_radius / 400.0) # Normalize radius
